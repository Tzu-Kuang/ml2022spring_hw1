...
def select_feat(train_data, valid_data, test_data, select_all=True):
    ...
    if select_all:
        ...
        feat_idx = list(range(101,117)) # TODO: Select suitable feature columns.
...
def trainer(train_loader, valid_loader, model, config, device):
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=config['learning_rate'], betas=(0.9, 0.999), weight_decay = 0.0) 
...
config = {
    'seed': 2000,      # Your seed number, you can pick your lucky number. :)
...
If this block does not display your learning curve, please wait for few minutes, and re-run this block. 
